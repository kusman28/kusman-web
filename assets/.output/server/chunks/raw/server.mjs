import { version, getCurrentInstance, defineComponent, computed, ref, h, resolveComponent, reactive, useSSRContext, createApp, toRef, isRef, mergeProps, defineAsyncComponent, provide, onErrorCaptured, unref, inject } from 'vue';
...
const ___node_modules_nuxt_dist_head_runtime_lib_vueuse_head_plugin_mjs_K47gbvdRmu = defineNuxtPlugin((nuxtApp) => {
...
const ___node_modules_nuxt_dist_app_plugins_router_mjs_ImrxePpayI = defineNuxtPlugin((nuxtApp) => {
...
const _plugins = [
  ...
  ___node_modules_nuxt_dist_head_runtime_lib_vueuse_head_plugin_mjs_K47gbvdRmu,
  ___node_modules_nuxt_dist_app_plugins_router_mjs_ImrxePpayI
];
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const ErrorComponent = defineAsyncComponent(() => import('./error-component.43002810.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
