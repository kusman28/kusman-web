...
const getClientManifest = () => import('./raw/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getStaticRenderedHead = () => import('./rollup/_virtual_head-static.mjs').then((r) => r.default || r);
const getServerEntry = () => import('./raw/server.mjs').then((r) => r.default || r);
const getSSRStyles = () => import('./raw/styles.mjs').then((r) => r.default || r);
